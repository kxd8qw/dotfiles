...
git clone --depth=1 https://gitlab.postmarketos.org/postmarketOS/pmbootstrap "$VIRTUAL_ENV/pmbootstrap" \
git clone -b master_staging_systemd https://gitlab.postmarketos.org/postmarketOS/pmaports.git "$HOME/.local/var/pmbootstrap/cache_git/pmaports" \
